...
class transport_bill(models.Model):
    ...
    date_out_in_related = fields.Date('进仓日期',related='date_out_in',readonly=True)
    date_in_related = fields.Date('入库日期',related='date_in',readonly=True)
    date_ship_related = fields.Date('出运船日期',related='date_ship',readonly=True)
    date_customer_finish_related = fields.Date('客户交单日期',related='date_customer_finish',readonly=True)
    date_supplier_finish_related = fields.Date('供应商交单确认日期',related='date_supplier_finish',readonly=True)
