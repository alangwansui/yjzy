...
class AccountPayment(models.Model):
    ...
    btd_line_ids = fields.One2many('back.tax.declaration.line', 'tuishuirld_id', u'申报明细',domain=[('back_tax_type','!=','adjustment')])
    ...
    declaration_state = fields.Selection(
        ...
        related='back_tax_declaration_id.state')
    rcsktsrld_ids = fields.One2many('account.payment','tuishuirld_id',u'收款退税认领',)

    rcsktsrld_id = fields.Many2one('account.payment',u'收款退税账单认领')
    tuishuirld_id = fields.Many2one('account.payment',u'退税申报账单')
