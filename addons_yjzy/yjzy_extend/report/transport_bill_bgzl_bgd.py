...
class ParticularReport(models.AbstractModel):
    _name = 'report.yjzy_extend.report_transport_bill_bgzl_bgd'

    @api.model
    def get_report_values(self, docids, data=None):
        report = self.env['ir.actions.report']._get_report_from_name('yjzy_extend.report_transport_bill_bgzl_bgd')
        return {
            'doc_ids': docids,
