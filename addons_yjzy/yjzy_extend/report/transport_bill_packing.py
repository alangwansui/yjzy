...
class ParticularReport(models.AbstractModel):
    _name = 'report.yjzy_extend.report_transport_bill_packing'

    @api.model
    def get_report_values(self, docids, data=None):
        report = self.env['ir.actions.report']._get_report_from_name('yjzy_extend.report_transport_bill_packing')
        return {
            'doc_ids': docids,
