...
class sh_export_product_image_var(models.TransientModel):
    ...
    product_varient_ids = fields.Many2many('product.product', string='Product Varients', store=False)
    ...
    def default_get(self, fields):
        rec = super(sh_export_product_image_var, self).default_get(fields)
