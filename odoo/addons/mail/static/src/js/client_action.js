...
var ChatAction = Widget.extend(ControlPanelMixin, {
    ...
    _fetchAndRenderThread: function () {
        var self = this;
        console.info('==_fetchAndRenderThread===', this.channel.id, this.domain);
        console.info('>>>', chat_manager.get_messages);
        ...
        return chat_manager.get_messages({channel_id: this.channel.id, domain: this.domain}).then(function (result) {
            ...
            console.info('==_fetchAndRenderThread===',result);
    ...
    _onChannelClicked: function (event) {
        ...
        console.info('==_onChannelClicked=', channel_id, chat_manager.get_channel(channel_id));
