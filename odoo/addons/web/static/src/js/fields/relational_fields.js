    ...
    _search: function (search_val) {
        ...
        this._rpc({
            ...
            .then(function (result) {
                ...
                if (self.nodeOptions.quick_create &&  search_val.length > 0 && !_.contains(raw_result, search_val)) {
                    values.push({
