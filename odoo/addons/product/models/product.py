...
class ProductProduct(models.Model):
    ...
    lst_price = fields.Float('Sale Price', help="The sale price is managed from the product template. Click on the 'Variant Prices' button to set the extra attribute prices.")
